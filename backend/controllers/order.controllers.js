...
//     const shopOrder = assignment.order.shopOrders.find(so => String(so._id) == String(assignment.shopOrders))
...
//   // }
//   } catch (error) {
//     console.log("CURRENT ORDER ERROR:", error.response?.data)
...
export const getCurrentOrder = async (req, res) => {
  try {
    // console.log("🔥 GET CURRENT ORDER RUNNING")
    ...
    // console.log("ORDER:", assignment.order)

    // console.log(
    //   "ORDER SHOP ORDERS:",
    //   assignment.order.shopOrders.map(so => String(so._id))
    // )

    // console.log(
    //   "ASSIGNMENT SHOP ORDER ID:",
    //   String(assignment.shopOrderId)
    // )
