...
const AddItem = () => {
  ...
  return (
    <div className="flex justify-center flex-col items-center p-6 bg-gradient-to-br from-orange-50 relative min-h-screen">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            {frontendImage && <div className="mt-4">
              <img src={frontendImage} alt="frontendImage" className="w-full h-48 object-cover rounded-lg border" />
            </div>}
          ...
          <button className="w-full bg-[#ff4d2d] text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-orange-600 hover:shadow-lg transition-all duration-200 cursor-pointer" disabled={loading}  onClick={() => navigate("/")}>
